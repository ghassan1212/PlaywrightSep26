      ...
      - generic [ref=e11]:
        ...
        - generic [ref=e16]:
          - generic [ref=e18]:
            ...
            - textbox "Username" [active] [ref=e23]: username
          - generic [ref=e25]:
            - generic [ref=e26]:
              - generic [ref=e27]: 
...
```ts
  ...
  20 | 
  21 | await page.getByPlaceholder('Username').fill('username');
  22 | 
> 23 | console.log(usernam);
     |             ^ ReferenceError: usernam is not defined
  24 | 
  25 | const password  = await page.getByPlaceholder('Username').fill('password');
  26 | 
  27 | console.log(password);
  28 | 
  29 | await page.getByRole('button', { name: 'Login', exact: true }).click();
  30 | 
  31 | });
```